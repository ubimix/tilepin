...
var IO = Tilepin.IO = {
    ...
    visit : function visit(file, visitor) {
        return Tilepin.P.ninvoke(FS, 'stat', file).then(function(stat) {
            ...
            return Tilepin.P().then(function() {
                ...
                if (result === false || !directory)
                    return;
                return Tilepin.P.ninvoke(FS, 'readdir', file).then(function(list) {
                    return Tilepin.P.all(_.map(list, function(f) {
